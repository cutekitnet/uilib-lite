...
$(document).on('ready', function () {
	...
	new Swiper('.slider-swiper-alpha .swiper-container', {
	...
	// caroussel slider-swiper-beta
	new Swiper('.slider-swiper-beta .swiper-container', {
	...
	$('.slider-swiper-beta .swiper-slide .media-slide-item-beta').css('min-height',$('.slider-swiper-beta .swiper-container').height());
	...
	var scrollpageContainer = $('.scrollpage-container');
	...
	if (fullpageContainer.hasClass('scroll-slideshow')) {
		scrollOverflow = true;
		autoScrolling = true;
	}
